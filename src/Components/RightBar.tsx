...
export const RightBar = () => {
    ...
    <section className='flex flex-col w-[20%] items-center pt-4 bg-[#001529] gap-2 overflow-hidden'>
        <h3 className='font-roboto text-white font-bold text-xl'>Libros encontrados</h3>
        ...
        <div className='w-[100%] gap-2 justify-center flex px-3 p-2 items-center'>
            ...
            <button onClick={onSendPdf} disabled={status} className='font-roboto text-white font-semibold
